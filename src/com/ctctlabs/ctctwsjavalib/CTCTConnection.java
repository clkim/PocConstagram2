...
public class CTCTConnection extends DefaultHandler {
	public static final String API_BASE = "https://api.l1.constantcontact.com";
	public static final String OAUTH2_TOKENINFO_LINK = "https://oauth2.l1.constantcontact.com/oauth2/tokeninfo.htm";
